...
export declare const withRequiresFullScreen: import("../Plugin.types").ConfigPlugin<void>;
export declare function getRequiresFullScreen(config: ExpoConfig): boolean;
export declare function setRequiresFullScreen(config: ExpoConfig, infoPlist: InfoPlist): {
