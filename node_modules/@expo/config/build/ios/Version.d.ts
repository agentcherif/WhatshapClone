...
export declare const withVersion: import("../Plugin.types").ConfigPlugin<void>;
export declare const withBuildNumber: import("../Plugin.types").ConfigPlugin<void>;
export declare function getVersion(config: ExpoConfig): string;
export declare function setVersion(config: ExpoConfig, infoPlist: InfoPlist): {
...
export declare function getBuildNumber(config: ExpoConfig): string;
export declare function setBuildNumber(config: ExpoConfig, infoPlist: InfoPlist): {
