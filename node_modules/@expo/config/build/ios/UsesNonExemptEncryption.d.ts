...
export declare const withUsesNonExemptEncryption: import("../Plugin.types").ConfigPlugin<void>;
export declare function getUsesNonExemptEncryption(config: ExpoConfig): boolean | null;
export declare function setUsesNonExemptEncryption(config: ExpoConfig, { ITSAppUsesNonExemptEncryption, ...infoPlist }: InfoPlist): {
