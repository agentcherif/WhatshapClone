...
export declare const withBranch: import("../Plugin.types").ConfigPlugin<void>;
export declare function getBranchApiKey(config: ExpoConfig): string | null;
export declare function setBranchApiKey(config: ExpoConfig, infoPlist: InfoPlist): InfoPlist | {
    branch_key: {
        live: string;
    };
