...
export declare const withOrientation: import("../Plugin.types").ConfigPlugin<void>;
export declare function getOrientation(config: ExpoConfig): "default" | "portrait" | "landscape" | null;
...
export declare function setOrientation(config: ExpoConfig, infoPlist: InfoPlist): {
