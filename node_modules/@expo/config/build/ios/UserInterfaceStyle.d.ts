...
export declare const withUserInterfaceStyle: import("../Plugin.types").ConfigPlugin<void>;
export declare function getUserInterfaceStyle(config: ExpoConfig): string | null;
export declare function setUserInterfaceStyle(config: ExpoConfig, { UIUserInterfaceStyle, ...infoPlist }: InfoPlist): {
